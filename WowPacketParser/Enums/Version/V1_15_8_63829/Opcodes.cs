...
namespace WowPacketParser.Enums.Version.V1_15_8_63829
{
    public static class Opcodes_1_15_8
    {
        ...
        private static readonly BiDictionary<Opcode, int> ServerOpcodes = new()
        {
            ...
            { Opcode.SMSG_BATTLE_PAY_DISPLAY_CARD, 0x46022E },
            { Opcode.SMSG_LAST_CATALOG_FETCH_RESPONSE, 0x460379 },
            { Opcode.SMSG_BATCH_PRESENCE_SUBSCRIPTION, 0x4602E3 },
            { Opcode.SMSG_GENERATE_SSO_TOKEN_RESPONSE, 0x4602D1 },
            { Opcode.SMSG_SYNC_WOW_ENTITLEMENTS, 0x460308 },
